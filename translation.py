...
URL | filename | username | password"""
    DOWNLOAD_START = "Download started in **BOTXEX mode...**"
    UPLOAD_START = "Processing upload..."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 2GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thank you <a href='https://t.me/BOTXZX'>**BOTXZX**</a> for helping us in this journey ❤️"
...
Contact ADMIN if any error occurs @BOTXZX"""
    ...
    LAZY_START_TEXT = """𝙷𝚎𝚕𝚕𝚘 baby {},

𝗬𝗼𝘂 𝗺𝘂𝘀𝘁 𝗯𝗲 𝗮𝗻 𝗔𝘂𝘁𝗵𝗲𝗻𝘁𝗶𝗰 𝗨𝘀𝗲𝗿 𝘁𝗼 𝘂𝘀𝗲 𝗺𝗲.
The **BOTXZE** has not allowed me to upload files from the urls which is send by an unAuthorised member.
